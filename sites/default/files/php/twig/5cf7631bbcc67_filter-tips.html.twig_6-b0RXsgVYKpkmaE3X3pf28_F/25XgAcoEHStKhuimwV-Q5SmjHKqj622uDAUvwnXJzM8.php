...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "id", [])), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/classy/templates/content-edit/filter-tips.html.twig", "/opt/lampp/htdocs/drupal/sample/core/themes/classy/templates/content-edit/filter-tips.html.twig");
    }
}
